...
// 1.5 其他UIKit相关
#define RGB(A, B, C, a)  [UIColor colorWithRed:A/255.0 green:B/255.0 blue:C/255.0 alpha:a]
#define UI_NAVIGATION_BAR_HEIGHT    44
#define UI_TAB_BAR_HEIGHT           49
#define UI_STATUS_BAR_HEIGHT        20
#define UI_SCREEN_WIDTH             320
#define UI_SCREEN_HEIGHT            480
#define UI_NAVIGATION_BAR_MAXY      UI_STATUS_BAR_HEIGHT + UI_NAVIGATION_BAR_HEIGHT
...
#define UI_BUTTON_FONT_SIZE         15
#define UI_BUTTON_FONT              [UIFont systemFontOfSize:UI_BUTTON_FONT_SIZE]

#define UI_BUTTON_BOTTOM_HEIGHT     40
#define UI_BUTTON_CORNERRADIUS      3

#define ColorWithHEX(hex) [UIColor colorWithHexString:hex alpha:1.0]
#define UI_BACKGROUND_COLOR ColorWithHEX(@"#EEEEEE")
#define UI_MAIN_COLOR ColorWithHEX(@"#E60012")
#define UI_LINE_COLOR ColorWithHEX(@"#C1C1C1")
#define UI_FONT_COLOR ColorWithHEX(@"#333333")
#define UI_BLUE_COLOR ColorWithHEX(@"00B7EE")
...
// 2.3 placeholder图片
#define ImagePlaceHolder [UIImage imageNamed:@"placeholder"]
//#define ImagePlaceHolder nil

// 2.4 document路径
#define kDocumentPath NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES)[0]

// 2.5 导航栏返回按钮图片
#define NavBackImage [UIImage imageNamed:@"back"]
...
// 3. 网络
// 3.1 返回结果
#define kResponseStatus [responseObj[@"status"] integerValue]
#define kResponseMsg [NSString getValidStringWithObject: responseObj[@"message"]]
#define kResponseData responseObj[@"data"][@"data"]



// 4. 其他
#define kTimeZone [NSTimeZone systemTimeZone]
